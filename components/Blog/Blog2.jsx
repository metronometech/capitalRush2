          ...
          >
            <div data-aos="fade-up" data-aos-delay="200"  data-aos-duration="1000" className="flex flex-col text-center mb:mt-10 mb:justify-center mb:text-left mb:max-w-[354px] w-full mb:pl-14">
              ...
              <h2 className=" font-poppins  -mt-1 text-[32px] font-bold leading-10">
                LOREM IPSUM IS A DUMMY TEXT WHICH USED FOR TEXT
              </h2>
              <p className=" -mt-1 text-[16px] text-[#B3B3B3] font-quicksand font-normal leading-6">
                Learning how to build rapport is important for any business that
                wants to have a genuine connection with its prospects. Greater
                rapport means more conversions.
              </p>
...
Adding a suitable picture is also important – the recipient might click on the sender’s profile, and if they see a stock photo, they’ll quickly move this email to spam (which, obviously, will have catastrophic consequences for your entire campaign).</p>
      ...
      <div>
        <div data-aos="fade-up" data-aos-delay="150"  data-aos-duration="1000" className=" py-10 pl-2 mb:pl-24  mb:mx-auto mb:justify-center   max-w-screen-xl ">
      ...
      <div data-aos="fade-up" data-aos-delay="200"  data-aos-duration="1000" className=" hidden mb:block  text-center mt-20 pb-6">
