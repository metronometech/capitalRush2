    ...
    <div className="pt-8 bg-[#100B26] ">
      ...
      <div className=" pt-16 flex flex-col items-center">
        ...
        <p className=" self-start mx-10  text-left  z-30 text-white font-quicksand opacity-70 text-[20px]">
          ...
          Rush is the company’s current flagship product, Metronome Technologies
          ...
          concerns or seek extra information about our Privacy Policy. This
          policy does not apply to data acquired offline or through channels
          other than this website. This website is intended to educate visitors
          about our policies regarding the collection, use, and sharing of
          Personal Information in case they choose to use our Service. If you
          decide to use our service, you agree to the collection and use of your
          information in line with this policy. The Personal Information we
          collect is used to deliver and enhance the Service. Except as stated
          in this privacy statement, we will not use or disclose your
          information to anyone else. The terms used in this Privacy Policy,
          unless otherwise specified, have the same meanings as those found in
          our Terms and Conditions, which are available on our website.
          Information Collection and Use We may ask for personally identifiable
          information from you while you use our service in order to provide you
          with a better experience, including but not limited to your IP
          address, legal name, age, gender, email, social media account
          information, avatars, skin tone, geographical information, and
          financial information. We’ll store the data you give us and use it as
          described in this privacy statement to improve the user experience.
          The software makes use of third-party services that could gather data
          used to identify you. Link to the privacy policy of third-party
          service providers used by the app (can be reviewed through click) are
          as follows:
        </p>
        ...
        <p className=" self-start mx-10  text-left  z-30 text-white font-quicksand opacity-70 text-[20px]">
          ...
          the Service, and other statistics. The investment strategy will be
          unique and varies from player to player so it can be shared to give
        ...
        <ul className=" self-start flex flex-col gap-3 mx-6">
          ...
          <li className=" text-white font-quicksand opacity-70 text-[20px] pl-4 ">
            If you feel any kind of security breach, or unauthorized disclosure
            of the login information, you must notify the Capital Rush team
            immediately;
          </li>
          <li className=" text-white font-quicksand opacity-70 text-[20px] pl-4 ">
            You are completely responsible for keeping the login information
            confidential, and you will be held liable for any and all uses of
            the login information, including purchases, whether or not you have
            authorized them.;
          </li>
          <li className=" text-white font-quicksand opacity-70 text-[20px] pl-4 ">
          ...
          <li className=" text-white font-quicksand opacity-70 text-[20px] pl-4 ">
            Capital Rush reserves the right to remove or reclaim any usernames
            at any time and for any reason, including but not limited to claims
            by a third party that a username violates such third party’s rights.
            The log data as specified will be removed after Thirty days of
            request received by user to remove the log data from the system.
            Cookies
          </li>
        </ul>
        ...
        <p className=" self-start mx-10 -mt-4 text-left  z-30 text-white font-quicksand opacity-70 text-[20px]">
          ...
          well as to provide information to website owners in order to improve
          the user experience in general, such as remembering your preferences
          or providing you with personalized content and advertisements. Other
          related technologies, such as log files, pixel tags, web beacons,
          clear GIFs, and device IDs, can fulfill the same functions as cookies.
        ...
        <ul className=" self-start flex flex-col gap-3 mx-16">
          <li className=" text-white font-quicksand opacity-70 text-[20px] pl-4 ">
          ...
          <li className=" text-white font-quicksand opacity-70 text-[20px] pl-4 ">
            Keep track of the overall number of users of a Service and the
            devices they use on a regular basis
          </li>
          <li className=" text-white font-quicksand opacity-70 text-[20px] pl-4 ">
        ...
        <p className=" self-start mx-10 -mt-4 text-left  z-30 text-white font-quicksand opacity-70 text-[20px]">
          ...
          some additional details on each category, purpose, and duration of the
          Cookies we and third parties use below. You can disable Cookies at any
          time using the Privacy Settings, but this may have an impact on how
          the Service works. Necessary Cookies <br />
          Essential features like security, network administration, and
          accessibility are made possible by necessary cookies. Necessary
          Cookies <br />
          Functional cookies keep track of the choices you’ve made and allow us
          to customize the Service for you. These Cookies allow us to offer you
          our services as you have requested them in the past when you continue
          to use or return to use a Service. These cookies, for example, enable
          us to display you when you are logged in and store your choices, such
          as your preferred language. Analytics Cookies <br />
          Analytics cookies track how our Service is accessed, used, and
          performed in order to give you a better user experience and to help us
          manage, operate, and develop it. These cookies allow us to:
        </p>
        <ul className=" self-start flex flex-col gap-3 mx-10">
          <li className=" text-white font-quicksand opacity-70 text-[20px] pl-4 ">
        ...
        <p className=" self-start mx-10 -mt-4 text-left  z-30 text-white font-quicksand opacity-70 text-[20px]">
          ...
          adverts on other websites. A list of advertising partners utilized in
          the Services can be found in our Privacy Policy. Please keep in mind
          that the advertising options you select in the Privacy Settings only
          apply to our Web Services. If you are a player of our Mobile Games and
          do not want to receive targeted advertisements, you can change your ad
          preferences via the in-app settings in certain of our games, or by
          contacting us at hello@capitalrush.gg If you join a Service using a
          social media platform, such third parties may set their own Cookies to
          track your usage of their platform. Also, if you click on a link to a
          third-party website (for example, in an ad), you will be directed to
        ...
        <ul className=" self-start flex flex-col gap-3 mx-10">
          ...
          <li className=" text-white font-quicksand opacity-70 text-[20px] pl-4 ">
            ...
            partners, for better customer service, to provide you with updates
            and other information relating to the website and product, and for
        ...
        <p className=" self-start mx-10 -mt-4 text-left  z-30 text-white font-quicksand opacity-70 text-[20px]">
          ...
          guarantee its absolute security, though we are very much concerned
          over the security of identity of every user and we follow all the
        ...
        <p className=" self-start mx-10 -mt-4 text-left  z-30 text-white font-quicksand opacity-70 text-[20px]">
          ...
          content of our web pages based on visitors’ browser types and/or other
          information, we can enhance the user experience. Links to Other Sites{" "}
          <br />
          Links to other websites may be found on this service. If you click on
          a third-party link, you will be taken to a third-party website. Please
          be aware that we do not control these external websites. <br />
          As a result, we strongly suggest that you read the Privacy Policies of
          these websites. The content, privacy practices, or other policies of
